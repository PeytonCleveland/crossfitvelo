...
import type { RouterOutputs } from "@crossfit-velo/api";
import { MEMBERSHIP } from "@crossfit-velo/api/validators";
...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from "@crossfit-velo/ui/dropdown-menu";
