...
import type { PurchaseOrg } from "@crossfit-velo/api/validators";
import { purchaseOrgSchema } from "@crossfit-velo/api/validators";
import { cn } from "@crossfit-velo/ui";
import { Avatar, AvatarFallback, AvatarImage } from "@crossfit-velo/ui/avatar";
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="crossfit-velo Inc." />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
