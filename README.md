...
There are two ways of initializing an app using the `crossfit-velo-corp` starter. You can either use this repository as a template:
...
```bash
npx create-turbo@latest -e https://github.com/juliusmarminge/crossfit-velo-corp
```
